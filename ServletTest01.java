...
public class ServletTest01 extends HttpServlet {
	...
	// service()메서드를 재정의 해서 작성하는 방법도 있다.
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		resp.setCharacterEncoding("UTF-8"); // 응답 문서의 인코딩 방식 지정 //문서를 읽어갈때의 인코딩방식
		resp.setContentType("text/html; charset=utf-8"); // 응답 문서의 ContentType 지정 //문서를 읽어서 화면에 보여줄때 인코딩방식
		
		// 처리한 내용을 응답으로 보내기 위해서 PrintWriter객체를 생성한다.
		PrintWriter out = resp.getWriter(); //문자기반의 스트림?
