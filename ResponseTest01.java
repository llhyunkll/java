...
public class ResponseTest01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 그에 따른 응답을 한다.
		// url값이 넘어가기 때문에 길이에 제한이 있다. (GET방식 규칙)
...
//								+ userName + "&tel=010-1234-5678"); //" " 안에 공백 없도록 작성 
		
		response.sendRedirect("/servletTest/basic/01/jspTest.jsp?username=" + userName + "&tel=010-1234-5678");
