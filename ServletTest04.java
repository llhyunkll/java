...
public class ServletTest04 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/*
		 * Servlet클래스나 JSP페이지의 환경에 관한 정보는 ServletContext인터페이스 타입의 객체를 
		 * 이용해서 구할 수 있다.
		 */
		...
		// 웹 컨테이너가 지원하는 Servlet규격서의 메이지 버전과 마이너 버전 구하기
		...
		out.printf("지원하는 Servlet 버젼(MajorVersion, MinorVersion) : (%d, %d)<br><br>"
